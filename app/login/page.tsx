    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            "w-full px-4 py-2.5 text-sm rounded-xl border border-[var(--border)]",
            "bg-[var(--card-bg)]/50 text-[var(--foreground)] placeholder:text-[var(--muted)]",
...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // placeholder: connect to auth
  };

  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[var(--bg-dark,#0F172A)]">
      {/* Background */}
      ...
      >
        ...
        <div className="glass rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-semibold text-white rounded-xl gradient-primary hover:opacity-90 shadow-lg hover:shadow-indigo-500/30 transition-all duration-200 mt-2 group"
            >
              Sign in
